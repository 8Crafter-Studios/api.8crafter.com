...
import { DeclarationReflection, ParameterType, ReflectionKind, ReflectionType, Renderer, } from "typedoc";
/**
...
export function load(app) {
    ...
    app.renderer.on(Renderer.EVENT_END, (event) => {
        ...
        outer: while (toProcess.length) {
            ...
            if (!symbolId || symbolId.fileName.includes("node_modules"))
                continue;
            ++expectedCount;
            if (hasComment) {
                ++actualCount;
        ...
        switch (outputType) {
            ...
            case CoverageOutputType.json:
                writeFileSync(outFileJson, JSON.stringify({
