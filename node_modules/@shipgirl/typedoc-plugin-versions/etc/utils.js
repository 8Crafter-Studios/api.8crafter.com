...
const packagePath = path.join(process.cwd(), '../Debug Sticks/BP/package.json');
    ...
    return ([
        ...
        ...versions
            ...
            try {
                ...
                return (fs.pathExistsSync(vPath) &&
...
export function getVersionAlias(version, stable = 'auto', dev = 'auto') {
    ...
    // semver.satisfies() automatically filters out prerelease versions by default
        ...
        return semver.satisfies(version, '>=1.0.0', true) ? 'stable' : 'dev';
}
/**
 ...
 */
export function getSemanticVersion(version = pack.version) {
    if (!version) {
...
function getPackageVersion(packageFile) {
