...
export function load(app) {
    ...
    app.converter.on(Converter.EVENT_CREATE_SIGNATURE, (context, reflection, sig) => {
        if (shouldParseSignature(context, reflection)) {
            plugin(context, reflection, sig);
        }
    });
}
function shouldParseDeclaration(context, reflection) {
    const ALLOWED_KINDS = [
        ReflectionKind.Enum,
...
function shouldParseSignature(context, reflection) {
