...
><select id="tsd-directory" title="The Current API Documentation" onchange="switch(this.value){
    case 'home': window.open('/html', '_self'); break;
...
export async function load(app) {
    ...
    app.converter.on(Converter.EVENT_BEGIN, () => {
        ...
        // app.converter.addUnknownSymbolResolver((symbol, refl, part, symbolId) => {
        //     console.log({moduleSource: symbol.moduleSource, resolutionStart: symbol.resolutionStart, symbolReference: {path: JSON.stringify(symbol.symbolReference?.path.map(p=>[p.navigation, p.path])), meaning: symbol.symbolReference?.meaning}, reflFullName: refl.getFullName(), part: {text: part?.text, tsLinkText: part?.tsLinkText}, symbolId: symbolId?.qualifiedName});
        // })
    });
